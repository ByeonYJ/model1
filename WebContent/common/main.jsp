			...
			<tr>
				<td>
					<ul class="index-ul" class="gms-list-style-none">
						<li><a href="<%=request.getContextPath()%>/member/member_add.jsp">학생 추가</a></li>
						<li><a href="<%=request.getContextPath()%>/member/member_list.jsp">학생 목록</a></li>
						<li><a href="<%=request.getContextPath()%>/member/member_search.jsp">학생 상세정보</a></li>
						<li><a href="<%=request.getContextPath()%>/member/member_update.jsp">학생 수정</a></li>
						<li><a href="<%=request.getContextPath()%>/member/member_delete.jsp">학생 삭제</a></li>
					</ul>
				</td>
				<td>
